...
public class BuehlmannTests
{
	...
	[Fact]
	public void CanReadBuehlmann()
	{
		XmlSerializer serializer = new(typeof(Buehlmann));
		Buehlmann buehlmann = serializer.Deserialize<Buehlmann>(Xml);
		buehlmann.Id.ShouldBe("zh-l16c");
		buehlmann.Tissues.Count.ShouldBe(16);
	}
}